...
#Tested on EV3Lessons Debian for EV3 (based on ev3dev 4.4 kernel) Works on ev3dev GNU/Linux w/ kernel 4.4 Most linux(es) will work if they use a *in*x (Minix, Linux, FreeBSD) kernel like ev3dev 4.4
